...
export function Minesweeper() {
  ...
  return (
    <div className="h-full bg-[#c0c0c0] p-2 flex flex-col items-center text-black">
      <div
      ...
      >
        ...
        <button
          onClick={init}
          className="w-8 h-8 bg-[#c0c0c0] text-xl"
          style={{ boxShadow: "inset -1px -1px 0 0 #404040, inset 1px 1px 0 0 #fff" }}
        >
          {over ? "😵" : won ? "😎" : "🙂"}
        </button>
      ...
      {(over || won) && <div className="text-xs mt-2">{won ? "¡Ganaste!" : "Boom!"}</div>}
    </div>
  )
}
